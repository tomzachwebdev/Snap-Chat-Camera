...
//        self.addGestureRecognizer(UILongPressGestureRecognizer(target: self, action: #selector(touchDown(sender:))))
    }
...
//        self.addTarget(self, action: #selector(touchDown), for: UIControl.Event.touchDown)
    ...
    {
        print("touch down in button class")
        ...
        morph.toValue = UIColor(displayP3Red: 1, green: 0, blue: 0, alpha: 0.5).cgColor//UIColor(colorLiteralRed: 1, green: 0, blue: 0, alpha: 0.5).cgColor
